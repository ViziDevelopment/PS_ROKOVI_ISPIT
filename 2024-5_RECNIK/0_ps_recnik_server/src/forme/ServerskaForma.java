...
public class ServerskaForma extends javax.swing.JFrame {
     ...
     */
    public ServerskaForma() throws SQLException {
        initComponents();
        ps= new PokreniServer();
        ps.start();
        
        
        ot= new OsveziTabeluNit(this);
        ot.start();
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(jTableRecnik);
    ...
    public void popunitabelu() throws SQLException {
        
        List<Korisnik> lista = Controller.getInstance().vratiSveKorisnike();
        ModelTabeleKorisnici mtk= new ModelTabeleKorisnici(lista);
